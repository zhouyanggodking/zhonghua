...
<style>
  ...
  .uploader-file-status span {
    flex: 0.7;
  }
  .uploader-file-status .success {
    color: #7FE085;
  }
  .uploader-file-status .failed {
    color: #D0021B;
  }
  .uploader-file-status .paused {
    color: #F5A623;
  }
  .uploader-file-status span .el-progress .el-progress-bar .el-progress-bar__inner {
    display: flex;
    align-items: center;
